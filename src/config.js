...
const PETTING_CONFIG = {
  ...
  RUB_NUDGE_DISTANCE: 4,
  RUB_NUDGE_LIFT: 1,
};

const STARTLED_CONFIG = {
  APPROACH_DISTANCE: 120,
  FAST_APPROACH_DISTANCE_MULTIPLIER: 1.25,
  FAST_RUN_CHANCE_BONUS: 0.18,
  FAST_SPEED_MULTIPLIER: 1.35,
...
const IDLE_BEHAVIOR_CONFIG = {
  COOLDOWN_MS: 1800,
  EDGE_REST_CHANCE: 0.35,
  LONG_IDLE_SLEEP_MS: 1000 * 60 * 8,
  LONG_IDLE_SLEEP_WEIGHT_MULTIPLIER: 3.4,
  LONG_IDLE_VARIATION_WEIGHT_MULTIPLIER: 1.7,
  RECENT_ACTION_REPEAT_COOLDOWN_MS: 9000,
  LONG_IDLE_VARIATION_IDS: [
    IDLE_ACTION_IDS.GROOM,
    IDLE_ACTION_IDS.LOOK,
    IDLE_ACTION_IDS.SCAN,
    IDLE_ACTION_IDS.TAIL,
  ],
  TABLE: [
...
const MOUSE_GAZE_CONFIG = {
  ...
  AXIS_DEAD_ZONE: 18,
  DIRECTION_DELAY_MS: 140,
  TRANSITION_MS: 180,
};

const MOUSE_APPROACH_CONFIG = {
  REACTION_DELAY_MS: 320,
};
